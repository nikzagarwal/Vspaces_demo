    ...
    var locations=[ ['<div class="infobox"><h3 class="title"><a href="#">OUR OFFICE</a></h3><span>BANGALORE</span><span></span></div>',
    12.3341, 76.6282,
    2]];
    var map=new google.maps.Map(document.getElementById('map'), {
        ...
        ], center: new google.maps.LatLng(12.3341, 76.6282), mapTypeId: google.maps.MapTypeId.ROADMAP
    }
